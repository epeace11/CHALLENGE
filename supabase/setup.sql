...
create table public.challenge_config(id integer primary key default 1 check(id=1),name text not null default 'September Challenge',start_date date not null default '2026-09-08',end_date date not null default '2026-09-30',finalized boolean not null default false);
