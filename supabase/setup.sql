...
insert into public.challenge_rules values ('bed','In bed by 11 pm, then read until you sleep',null,true,false,false),('screens','No screens in the bedroom',null,true,false,false),('weed','No smoking weed',null,true,false,false),('prayer','Pray daily',null,false,false,false),('food','No eating out',null,false,false,false),('time','Screen time: 1 hour or less',null,false,true,false),('entertainment','No entertainment before 6 pm',null,false,false,false),('steps','10,000 steps','Erin',false,true,false),('calories','2,300 calories or less + macros tracked','Kazzy',false,true,false),('gym','Go to gym',null,false,false,true);
